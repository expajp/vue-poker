...
describe("勝敗を判定する", () => {
  ...
  it("両者Noneならば引き分け", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(new None(playersHand), new None(dealersHand))
    ).toBe("Draw");
  });
  ...
  it("役が異なるならば強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new StraightFlash(playersHand),
        new RoyalStraightFlash(dealersHand)
      )
    ).toBe("You Lose");
  });
  ...
  it("フォーカードどうしで数字を比較して強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new FourCard(playersHand),
        new FourCard(dealersHand)
      )
    ).toBe("You Lose");
  });
  ...
  it("フルハウスどうしで3枚組の数字を比較して強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new FullHouse(playersHand),
        new FullHouse(dealersHand)
      )
    ).toBe("You Win");
  });
  ...
  it("フラッシュどうしで数字を比較して強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new Flash(playersHand),
        new Flash(dealersHand)
      )
    ).toBe("You Win");
  });
  ...
  it("ストレートどうしで数字を比較して強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new Straight(playersHand),
        new Straight(dealersHand)
      )
    ).toBe("You Win");
  });
  ...
  it("スリーカードどうしならば数を比較して強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new ThreeCard(playersHand),
        new ThreeCard(dealersHand)
      )
    ).toBe("You Win");
  });
  ...
  it("ツーペアどうしで強い方の数が同じならば弱い方を比較してより強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new TwoPair(playersHand),
        new TwoPair(dealersHand)
      )
    ).toBe("You Lose");
  });
  ...
  it("ワンペアどうしならば、ペアの数字が強いほうが勝利", () => {
    ...
    expect(
      game.vm.judgeVictoryOrDefeat(
        new OnePair(playersHand),
        new OnePair(dealersHand)
      )
    ).toBe("You Win");
  });
  ...
  it("全く同じ内容ならば、エラーを投げる", () => {
    ...
    expect(() => {
      game.vm.judgeVictoryOrDefeat(
        new RoyalStraightFlash(playersHand),
        new RoyalStraightFlash(dealersHand)
      );
